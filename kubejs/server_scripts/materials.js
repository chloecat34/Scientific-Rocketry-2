ServerEvents.recipes((event) => {
    ...
    // Red alloy
    event.recipes.createFilling("kubejs:red_alloy_ingot", [
        "#forge:ingots/copper",
        Fluid.of("thermal:redstone", 400),
    ]);
    event.recipes.thermal
        .smelter("2x kubejs:red_alloy_ingot", [
            "#forge:ingots/copper",
    ...
    // Energetic alloy
    event.recipes
        .createMixing("kubejs:energetic_alloy_ingot", [
            "#forge:ingots/electrum",
            "2x kubejs:energetic_blend",
        ])
        .heated();
    event.recipes.thermal
        .smelter("kubejs:energetic_alloy_ingot", [
            "#forge:ingots/electrum",
            "2x kubejs:energetic_blend",
        ])
        .energy(6400);
    ...
    event.recipes.thermal
        .smelter("kubejs:vibrant_alloy_ingot", [
            "#forge:ingots/energetic_alloy",
            "minecraft:ender_eye",
        ])
        .energy(9600);
    ...
    event.recipes.thermal
        .smelter("8x #forge:gems/black_quartz", [
            "8x #forge:gems/quartz",
            "#forge:dusts/hop_graphite",
        ])
        .energy(12800);
    ...
    event.recipes.thermal
        .smelter("#forge:ingots/electrical_steel", [
            "#forge:ingots/steel",
            "#forge:silicon",
        ])
        .energy(9600);
